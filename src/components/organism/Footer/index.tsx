        ...
        <footer>
            ...
            <div className={classNames("bg-gray-800", !showStartLearningBanner ? "mt-16" : "")}>
                <div className="flex justify-between mx-auto px-4 lg:px-6 py-12 text-center flex-wrap lg:flex-nowrap flex-col lg:flex-row max-w-6xl">
                    ...
                    <Column>
                        <div>
                            <div className="mb-8 font-bold text-lg uppercase text-primary-500">Navigation</div>
                    ...
                    <Column>
                        <div>
                            <div className="mb-8 font-bold text-lg uppercase text-primary-500">Contact</div>

                            <ul>
                                <FooterItem href="mailto:info@journeyz.io">
                                ...
                                <FooterItem href="https://discord.com/invite/PLACEHOLDER">
                    ...
                    <Column className="mr-0">
                        <div>
                            <div className="mb-8 font-bold text-lg uppercase text-primary-500">Legal</div>

                            <ul>
                                <FooterItem href="/legal-notice">
                                    Legal notice
                                </FooterItem>

                                <FooterItem href="/general-conditions">
